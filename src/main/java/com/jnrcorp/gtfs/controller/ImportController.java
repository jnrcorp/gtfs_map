...
public class ImportController {
	...
	private static File gtfsIngestionFile1 = new File("/usr/local/gtfs/bus_data/agency.txt");
	private static File gtfsIngestionFile2 = new File("/usr/local/gtfs/bus_data/routes.txt");
	private static File gtfsIngestionFile3 = new File("/usr/local/gtfs/bus_data/calendar_dates.txt");
	private static File gtfsIngestionFile4 = new File("/usr/local/gtfs/bus_data/shapes.txt");
	private static File gtfsIngestionFile5 = new File("/usr/local/gtfs/bus_data/trips.txt");
	private static File gtfsIngestionFile6 = new File("/usr/local/gtfs/bus_data/stops.txt");
	private static File gtfsIngestionFile7 = new File("/usr/local/gtfs/bus_data/stop_times.txt");
