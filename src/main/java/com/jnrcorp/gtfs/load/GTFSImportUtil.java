...
public class GTFSImportUtil {
	...
	private final static String[] IMPORT_HEADER = new String[] {
		...
		GTFSImportConstants.HEADER_SHAPE_DISTANCE_TRAVELED,
		GTFSImportConstants.HEADER_SHAPE_ID,
		GTFSImportConstants.HEADER_SHAPE_POINT_LATITUDE,
		GTFSImportConstants.HEADER_SHAPE_POINT_LONGITUDE,
		GTFSImportConstants.HEADER_SHAPE_POINT_SEQUENCE,
